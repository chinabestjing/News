		...
		<div class="table-responsive">
			<table class="table table-hover">
                ...
                <tr>
                    <td>所属学学校</td>
                    <td>
                        <select name="user_uid" class="form-control w400" autocomplete="off">
                            <?php if(is_array($school)): foreach($school as $key=>$v): ?><option value="<?php echo ($v["uid"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
				-->
                <tr>
                    ...
                    <td>
                        <select name="unit" class="form-control w400">
                            ...
                            <?php if(is_array($unit)): $i = 0; $__LIST__ = $unit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$unit): $mod = ($i % 2 );++$i;?><option value="<?php echo ($unit["u_name"]); ?>"><?php echo ($unit["u_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <tr>
                    <td>购买送积分</td>
                    <td>
                        <input type="text" name="credits" value="0" class="form-control w400 fl">
				...
				<tr>
					...
					<td>
						...
						<b class="fl ml10 mt10" style="color: red;">0为没有库存限制（预售商品请设置库存）</b>
					</td>
				</tr>
				<tr>
					<td>所属分类</td>
                ...
                <tr>
                    <td>商品简介</td>
                    <td>
                        <textarea name="tiny_description" class="description_box"></textarea>
                    </td>
                </tr>
               ...
               <!-- <tr>
                    ...
                    <td>
                        <div class="col-sm-10">
                            <script type="text/plain" id="container" name="description" style="width:78%;height:300px;"></script>
                        </div>
                    </td>
                </tr>-->
	...
	$('#file_upload').uploadify({
		...
		'onFallback' : function() {
            alert('未检测到兼容版本的Flash.');
				...
				<tr>
					<td></td>
					<td><input type="hidden" name="user_uid" value="8">

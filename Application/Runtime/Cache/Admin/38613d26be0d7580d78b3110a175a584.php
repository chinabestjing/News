        ...
        <div class="modal-content">
            ...
            <form action="<?php echo U('Coupon/add_coupon');?>" method="post" class="form-horizontal">
                <div class="modal-body clearfix">
                    ...
                    <div class="form-group clearfix mt10">
                        <label class="col-sm-2 control-label">发放对应商家</label>
                        <div class="col-sm-10">
                            <select name="uid" class="form-control w200">
                                <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><option value="<?php echo ($user["uid"]); ?>"><?php echo ($user["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>

...
<script>
	...
	<div id="right-content">
		...
		<form action="/index.php/Admin/Group/teamUpdate" method="post">
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					<td width="150">用户名</td>
					<td>
						<input type="text" name="m_name" class="form-control w400" value="<?php echo ($data['m_name']); ?>"  placeholder="名称设置" >
					</td>
				</tr>
				<tr>
					<td width="150">职位</td>
					<td>
						<input type="text" name="m_position" class="form-control w400" value="<?php echo ($data['m_position']); ?>"  placeholder="请填入该同事的职位" >
					</td>
				</tr>
                <tr>
                    <td width="150">学历</td>
                    <td>
                        <input type="text" name="m_study" class="form-control w400" value="<?php echo ($data['m_study']); ?>"  placeholder="请填入该同事的学历" >
                    </td>
                </tr>
                <tr>
                    <td width="150">排序（数字越大越靠前）</td>
                    <td>
                        <input type="number" name="m_order" class="form-control w400" value="<?php echo ($data['m_order']); ?>"  placeholder="" >
                    </td>
                </tr>
				<tr>
					<td>性别</td>
					<td>
						<div class="radio">
							<label>
								<input type="radio" name="m_sex" <?php if($data['m_sex'] == 1): ?>checked="checked"<?php endif; ?> value="1"> 女
							</label>
							<label>
								<input type="radio" name="m_sex" <?php if($data['m_sex'] == 0): ?>checked="checked"<?php endif; ?> value="0"> 男
							</label>
						</div>
					</td>
				</tr>
                <tr>
                    <td>简介</td>
                    <td>
                        <textarea name="m_intro"><?php echo ($data["m_intro"]); ?></textarea>
                    </td>
                </tr>
				<tr>
					<td>用户照片</td>
					<td>
						...
						<div class="up_box">
                            <p>
                                <input type="text" readonly name="m_pic" id="url1" value="<?php echo ($data['m_pic']); ?>" />
                                <input type="button" id="image1" value="选择图片" />（网络图片 + 本地上传）
                            </p>
                            <p id="pic1"></p>
							<img src="<?php echo ($data['m_pic']); ?>" alt="" width="150">
						</div>
						<!-- 载入上传文件 -->

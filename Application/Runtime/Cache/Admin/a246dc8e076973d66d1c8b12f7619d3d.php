...
<script>
	...
	<div id="right-content">
		<div class="top">
			<h2>轮播图管理 <small>设置</small></h2>
		</div>

		<form action="/index.php/Admin/Carousel/add" method="post">
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					...
					<td>
						<input type="text" name="b_url" class="form-control w400" value="<?php echo ($data['i_url']); ?>"  placeholder="名称设置" >
					</td>
				</tr>
				<tr>
					<td width="150">轮播图标题</td>
					<td>
						<input type="text" name="b_pic_text" class="form-control w400" value="<?php echo ($data['i_title1']); ?>"  placeholder="轮播图设置" >
					</td>
				</tr>

				<tr>
					<td>banner图片(1260X369)</td>
					<td>
						<!-- 图片上传 begin -->
						<div class="up_box">
                            <p>
                                <input type="text" readonly class="form-control w400" name="b_pic" id="url1" value="<?php echo ($data['i_pics']); ?>" />

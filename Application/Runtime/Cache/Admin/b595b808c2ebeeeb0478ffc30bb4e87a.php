...
<html lang="en">
	...
	<div class="clearfix2">
		...
		<div id="left-menu" class="fl">
            ...
            <p>
                <a href="<?php echo U('Group/index');?>" target="iframe">集团简介</a>
                <a href="<?php echo U('Group/talking');?>" target="iframe">董事长致辞</a>
                <a href="<?php echo U('Group/team');?>" target="iframe">管理团队</a>
                <a href="<?php echo U('Group/brand');?>" target="iframe">集团品牌</a>
                <a href="<?php echo U('Group/honor');?>" target="iframe">公司荣誉</a>
            </p>
            ...
            <h2><i class="glyphicon glyphicon-cog"></i>艺术教育设置</h2>
            <p>

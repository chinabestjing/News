        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <!--id隐藏域-->
                        <input name="n_id" value="<?php echo ($data["n_id"]); ?>" type="hidden" />
                        <input type="text" class="form-control w400" name="n_title" value="<?php echo ($data["n_title"]); ?>" />
                    </td>
                </tr>
                <tr>
                    <td>请选择新闻类型</td>
                    <td>
                        <select name="n_type" class="form-control w400">
                            <option <?php if($data["n_type"] == 1): ?>selected<?php endif; ?> value="1">集团新闻</option>
                            <option <?php if($data["n_type"] == 2): ?>selected<?php endif; ?> value="2">行业新闻</option>
                            <option <?php if($data["n_type"] == 3): ?>selected<?php endif; ?> value="3">媒体关注</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="col-sm-10">
                            <textarea name="n_text" style="width:800px;height:400px;visibility:hidden;"><?php echo ($data["n_text"]); ?></textarea>
                ...
                <tr>
                    <td>新闻简介</td>
                    <td>
                        <textarea name="n_intro" class="description_box"><?php echo ($data["n_intro"]); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td></td>

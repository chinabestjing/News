			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
							...
							<td class="handle">
								<?php if($v[status] == 0): ?><a href="<?php echo U('User/shops_status',array('uid'=>$v['uid'],'status'=>1));?>" class="edit"><i class="glyphicon glyphicon-pencil"></i>通过</a>
									<a href="<?php echo U('User/shops_status',array('uid'=>$v['uid'],'status'=>2));?>" class="del"><i class="glyphicon glyphicon-trash"></i>不通过</a>
								<?php elseif($v[status] == 1): ?>
									<a href="<?php echo U('User/shops_status',array('uid'=>$v['uid'],'status'=>2));?>" class="del"><i class="glyphicon glyphicon-trash"></i>不通过</a>
								<?php elseif($v[status] == 2): ?>
									<a href="<?php echo U('User/shops_status',array('uid'=>$v['uid'],'status'=>1));?>" class="edit"><i class="glyphicon glyphicon-pencil"></i>通过</a><?php endif; ?>
                                <a href="<?php echo U('User/shops_del',array('uid'=>$v['uid']));?>" class="del"><i class="glyphicon glyphicon-trash"></i>删除</a>
							</td>

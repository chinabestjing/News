...
<script>
	...
	<div id="right-content">
		<div class="top">
			<h2>艺术传媒 <small>微信微博</small></h2>
		</div>

		<form action="/index.php/Admin1/Media/tencent" method="post">
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					<td width="150">（微信）文章标题</td>
					<td>
						<input type="text" name="i_title1" class="form-control w400" value="<?php echo ($data['i_title1']); ?>"  placeholder="" >
					</td>
				</tr>
                ...
                <tr>
                    <td width="150">（微博）文章标题</td>
                    <td>
                        <input type="text" name="i_title2" class="form-control w400" value="<?php echo ($data['i_title2']); ?>"  placeholder="" >
                    </td>
                </tr>
                ...
                <tr>
                    <td>（微博）文章内容</td>
                    <td>
                        <textarea name="i_text2"  class="description_box" style="height: 400px;"><?php echo ($data["i_text2"]); ?></textarea>
                    </td>
                </tr>
				<tr>
					<td></td>

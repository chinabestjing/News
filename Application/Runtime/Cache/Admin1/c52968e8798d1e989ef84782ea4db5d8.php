            ...
            <table class="table table-hover">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="handle">
                            ...
                            <?php if($vo['is_itop'] == 0 ): ?><a href="<?php echo U('News/lanmuCheck',array('n_id'=>$vo['n_id'],'is_itop'=>$vo['is_itop']));?>" class="edit"><i class="glyphicon glyphicon-pencil"></i>栏目头条</a><?php endif; ?>

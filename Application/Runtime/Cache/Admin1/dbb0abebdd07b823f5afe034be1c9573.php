...
<div id="right-content">
    <div class="top">
        <h2>艺术传媒 <small>杂志列表</small></h2>
    </div>
    <ul class="nav nav-tabs mt10">
        <li role="presentation">
            <a href="/index.php/Admin1/Media/add" >新增杂志</a>
        </li>
    </ul>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["p_url"]); ?></td>


                        <td><?php echo (date('Y-m-d H:i:s',$vo["p_time"])); ?></td>
                        <td class="handle">

                           <!-- <a href="<?php echo U('Media/edit',array('p_id'=>$vo['p_id']));?>" class="edit"><i class="glyphicon glyphicon-pencil"></i>编辑</a>-->
                            <a href="javascript:;" class="del" onclick="if(confirm('确定删除吗？')) location.href='<?php echo U('Media/del', array('p_id'=>$vo['p_id']));?>'">

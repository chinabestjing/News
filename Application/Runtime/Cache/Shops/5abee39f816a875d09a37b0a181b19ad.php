...
<div id="right-content">
    <div class="top">
        <h2>银行卡管理 <small>绑定支付宝</small></h2>
    </div>
    <form action="<?php echo U('Bankcard/binding_alipay');?>" method="post" >
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div class="radio">
                            <input type="text" name="alipay_name" class="form-control w400" value="<?php echo ($row["alipay_name"]); ?>" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="radio">
                            <input type="text" name="alipay" class="form-control w400" value="<?php echo ($row["alipay"]); ?>" />
                        </div>
                    </td>
                </tr>

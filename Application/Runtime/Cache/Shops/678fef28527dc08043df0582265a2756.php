...
<div id="right-content">
    <div class="top">
        <h2>银行卡管理 <small>绑定银行卡</small></h2>
    </div>
    <form action="<?php echo U('Bankcard/binding_bankcard');?>" method="post" >
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div class="radio">
                            <input type="text" name="bank_name" class="form-control w400" value="<?php echo ($row["bank_name"]); ?>" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="radio">
                            <input type="text" name="bank_card" class="form-control w400" value="<?php echo ($row["bank_card"]); ?>" />
                        </div>
                    </td>
                </tr>
